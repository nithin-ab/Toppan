...
Debug.Print "Orderform Number:" & orderformnumber
...
Debug.Print "P.O. Numbers:" & ponumbers
Debug.Print "Site to Send Masks To:" & sitetosendmasksto
Debug.Print "Site to Send Invoice To:" & sitetosendinvoiceto
Debug.Print "Technical Contact:" & technicalcontact
Debug.Print "Shipping Method:" & shippingmethod
Debug.Print "Additional Information:" & additionalinfo


For Each k In revision2
   Debug.Print "revision2 elements:" & k
   Next k
For Each k In numn
   Debug.Print "numn elements:" & k
   Next k

For Each k In maskcodificationn
   Debug.Print "mask codification elements:" & k
   Next k
For Each k In groupn
   Debug.Print "GRP elements:" & k
   Next k
For Each k In cyclen
   Debug.Print "CYL elements:" & k
   Next k
For Each k In qtyn
   Debug.Print "QTY elements:" & k
   Next k
For Each k In shipdaten
   Debug.Print "ship date elements:" & k
   Next k

For Each k In cdnumn
   Debug.Print "CD NUM elements:" & k
   Next k

For Each k In cdnamen
   Debug.Print "CD NAME elements:" & k
   Next k

For Each k In featuren
   Debug.Print "Feature elements:" & k
   Next k
For Each k In tonen
   Debug.Print "Tone elements:" & k
   Next k
For Each k In polarityn
   Debug.Print "Polarity elements:" & k
   Next k
